...
<table style="width:640px;" cellspacing="0" cellpadding="10">
	<tr>
		<td>%to%</td><td><input type='hidden' name='userto' value='{usertoid}' /> <a href='memberlist.php?memberid={usertoid}'>{userto}</a></td>
	</tr>
	<tr>
		<td>%subject%</td><td><input type='text' class='textinput' name='subject' id='subject' value='{subject}' style='width:400px'/> &nbsp; <span id='subjectInfo' style='color:red'></span></td>
	</tr>
	<tr>
		<td>%message%</td><td><textarea class="resizable" id='message' style="width:500px;height:200px;" class="resizable">Hi {userto}, 

{link}

Thanks {userfrom}
		
		 </textarea><br  /><span id='messageInfo' style='color:red'></span></td>
	</tr>
	<tr>
